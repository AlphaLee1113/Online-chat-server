...
const ChatPanel = (function() {
    ...
    const initialize = function() {
        ...
        //IMPROEMENT : handle user typing
        $("#chat-input-form").on("keydown", (e) => {
            // not broadcasting the innerHtml="" to all user
            //myself should show nth
            clearTimeout(typingTimer);
            Socket.postTypingMessage();
            typingTimer = setTimeout(
                function() {
                    Socket.removeTypingMessage();
                }, 3000);
        });
    ...
    // IMPROVEMENT
    const updateTypeArea = function(name , message) {
        // console.log("here is ui and ", message);
        let current_user = document.querySelectorAll(".user-name")[0].innerHTML;
    ...
    return { initialize, update, addMessage, updateTypeArea };
})();
